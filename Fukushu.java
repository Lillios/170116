import javax.swing.*;
    ...
    public class Fukushu extends JFrame implements ActionListener {
    	...
    	Fukushu(String title){
    		...
    		radioB[0] = new JRadioButton("cold");	
    		radioB[1] = new JRadioButton("hot");
    		radioB[2] = new JRadioButton("medium");
    	...
    	public void actionPerformed(ActionEvent e){
    		...
    		for (int i=0; i<3; i++ ) {
    			if (this.radioB[i].isSelected()) {			
    				this.lbl.setText(checkData[0]+checkData[1]+checkData[2]+this.radioB[i].getText());
    			}
    		}
